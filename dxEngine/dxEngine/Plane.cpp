...
HRESULT Plane::CreateRootSignature(){
    HRESULT res = S_FALSE;
...
HRESULT Plane::CreateGraphicsPipeline(){
    HRESULT res = S_FALSE;
...
HRESULT Plane::CreateDescriptorHeap(){
    HRESULT res = S_FALSE;
...
void Plane::InitMatrix(){
    //ワールド行列
    matWorld = XMMatrixIdentity();
}

HRESULT Plane::CreateConstBuff(){
    HRESULT res = S_FALSE;
    // 定数バッファの生成
    res = device->CreateCommittedResource(
